...
export default function AboutSection() {
  ...
  return (
    <section className={`relative min-h-screen flex items-center overflow-hidden ${language === "ar" ? "rtl" : "ltr"}`}>
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image src="/images/common-bg.jpg" alt="About Background" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-black/40" />
      </div>

      {/* Content Container */}
      <div className="relative z-10 w-full h-full flex items-center py-20">
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-center">
            ...
            <div className="text-white space-y-6 relative">
              ...
              <button
                onClick={prevSlide}
                className="absolute -left-12 top-1/2 transform -translate-y-1/2 text-white hover:text-amber-400 transition-colors hidden lg:block"
              >
              ...
              <button
                onClick={nextSlide}
                className="absolute -right-12 top-1/2 transform -translate-y-1/2 text-white hover:text-amber-400 transition-colors hidden lg:block"
              >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="relative w-80 h-96 lg:w-96 lg:h-[500px] bg-amber-800 rounded-lg overflow-hidden shadow-2xl">
                  <Image
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-4 lg:hidden">
        <button onClick={prevSlide} className="text-white hover:text-amber-400 transition-colors p-2">
        ...
        <button onClick={nextSlide} className="text-white hover:text-amber-400 transition-colors p-2">
