...
const heroSlides = [
  ...
  },
  {
    ...
    descriptionAr:
      "نسعى لتقديم خدمات قانونية استثنائية بنزاهة ومهنية وتفان لنجاح عملائنا في كل قضية نتعامل معها",
    image: "/images/client-testimonial.png",
  },
  {
    id: 3,
...
export default function HomeHeroContent() {
  ...
  return (
    <section
      className={`relative flex items-center overflow-hidden w-full h-screen ${
        language === "ar" ? "rtl" : "ltr"
      }`}
    >
      {/* Background Image */}
        ...
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-center">
            ...
            <div className="text-white space-y-6 relative">
              <div className="max-w-lg pl-10 relative">
                {/* Previous Button */}
                <button
                  onClick={prevSlide}
                  className="absolute -left-12 top-0 text-white hover:text-white/80 transition-colors hidden lg:block"
                >
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  {language === "ar"
                    ? currentContent.titleAr
                    : currentContent.title}
                </h1>

                <p className="text-base md:text-base leading-relaxed mb-8 opacity-90">
                  {language === "ar"
                    ? currentContent.descriptionAr
                    : currentContent.description}
                </p>

                <Button
                  size="lg"
                  className="bg-white text-black hover:bg-gray-100 px-8 py-3 rounded-sm font-semibold"
                >
                ...
                <button
                  onClick={nextSlide}
                  className="absolute -right-12 top-0 text-white hover:text-white/80 transition-colors hidden lg:block"
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative pr-10">
                ...
                <div className="relative w-[374px] h-[374px] bg-[#4b2615] rounded-lg overflow-hidden shadow-2xl">
                  <Image
